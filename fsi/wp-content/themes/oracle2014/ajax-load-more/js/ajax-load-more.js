...
(function ($) {
    ...
    AjaxLoadMore.init = function () {
        ...
        if ($path === undefined) {
            $path = '/fsi/wp-content/themes/oracle2014/ajax-load-more';
        }
        ...
        //$el.append('<div class="load-more-btn-wrap col-md-9"><button id="load-more" class="more">' + $button_text + '</button></div>');
...
//        $path = $('#ajax-load-more ul').data('path');
//        if ($path === undefined) {
//            $path = '/fsi/wp-content/themes/oracle2014/ajax-load-more';
//        }
